...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
      <div className="max-w-5xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-lg font-semibold mb-2">自律的な執筆</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-lg font-semibold mb-2">一貫性の保証</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-lg font-semibold mb-2">最新AIモデル</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
